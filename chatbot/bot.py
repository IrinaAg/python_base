...
class Bot:
    ...
    def on_event(self, event):
        ...
        user_id = event.message.peer_id # event.object.peer_id
        text = event.message.text # event.object.text
        ...
        self.api.messages.send(message=text_to_send,
                               ...
                               peer_id=event.message.peer_id) # можно поменять на user_id
    ...
    def continue_scenario(self, user_id, text):
        ...
        if handler(text=text, context=state.context):  # event.object.text
            # next step
